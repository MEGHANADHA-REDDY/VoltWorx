          ...
          <div className="bg-gray-900 p-6 rounded-2xl w-full max-w-xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <input
                  type="file"
                  className="flex-1 p-2 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  accept=".pdf,.jpg,.png"
                />
              </div>
